...
function callback(element) {
  ...
  settingsButton.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="currentColor">
  ...
  <span class="te-tooltip te-settings te-tooltip-left">TwitchEnhancer Settings</span>
    `;
