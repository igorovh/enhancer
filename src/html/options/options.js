...
function updateTable() {
  ...
  document
    ...
    .forEach((button) => button.addEventListener('click', removeIcon, false));
  document
    .querySelectorAll('.remove-action')
    .forEach((button) => button.addEventListener('click', removeAction, false));
